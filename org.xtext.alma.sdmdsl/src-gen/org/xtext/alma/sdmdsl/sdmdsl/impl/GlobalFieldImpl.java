...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Global Field</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.xtext.alma.sdmdsl.sdmdsl.impl.GlobalFieldImpl#getPrimitiveType <em>Primitive Type</em>}</li>
 *   <li>{@link org.xtext.alma.sdmdsl.sdmdsl.impl.GlobalFieldImpl#getEnumeration <em>Enumeration</em>}</li>
 *   <li>{@link org.xtext.alma.sdmdsl.sdmdsl.impl.GlobalFieldImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.xtext.alma.sdmdsl.sdmdsl.impl.GlobalFieldImpl#isReadOnly <em>Read Only</em>}</li>
 *   <li>{@link org.xtext.alma.sdmdsl.sdmdsl.impl.GlobalFieldImpl#getInitValue <em>Init Value</em>}</li>
 *   <li>{@link org.xtext.alma.sdmdsl.sdmdsl.impl.GlobalFieldImpl#getDoc <em>Doc</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GlobalFieldImpl extends MinimalEObjectImpl.Container implements GlobalField
{
  /**
  ...
  {
    return SdmdslPackage.Literals.GLOBAL_FIELD;
  }
  ...
  public void setPrimitiveType(String newPrimitiveType)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SdmdslPackage.GLOBAL_FIELD__PRIMITIVE_TYPE, oldPrimitiveType, primitiveType));
  }
  ...
  public EnumType getEnumeration()
  {
    if (enumeration != null && enumeration.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SdmdslPackage.GLOBAL_FIELD__ENUMERATION, oldEnumeration, enumeration));
      }
    }
    return enumeration;
  }
  ...
  public void setEnumeration(EnumType newEnumeration)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SdmdslPackage.GLOBAL_FIELD__ENUMERATION, oldEnumeration, enumeration));
  }
  ...
  public void setName(String newName)
  {
    ...
    name = newName;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SdmdslPackage.GLOBAL_FIELD__NAME, oldName, name));
  }
  ...
  public void setReadOnly(boolean newReadOnly)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SdmdslPackage.GLOBAL_FIELD__READ_ONLY, oldReadOnly, readOnly));
  }
  ...
  public void setInitValue(String newInitValue)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SdmdslPackage.GLOBAL_FIELD__INIT_VALUE, oldInitValue, initValue));
  }
  ...
  public void setDoc(String newDoc)
  {
    ...
    doc = newDoc;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SdmdslPackage.GLOBAL_FIELD__DOC, oldDoc, doc));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SdmdslPackage.GLOBAL_FIELD__PRIMITIVE_TYPE:
        return getPrimitiveType();
      case SdmdslPackage.GLOBAL_FIELD__ENUMERATION:
        if (resolve) return getEnumeration();
        return basicGetEnumeration();
      case SdmdslPackage.GLOBAL_FIELD__NAME:
        return getName();
      case SdmdslPackage.GLOBAL_FIELD__READ_ONLY:
        return isReadOnly();
      case SdmdslPackage.GLOBAL_FIELD__INIT_VALUE:
        return getInitValue();
      case SdmdslPackage.GLOBAL_FIELD__DOC:
        return getDoc();
    }
