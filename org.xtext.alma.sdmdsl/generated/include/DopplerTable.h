...
class DopplerTable : public Representable {
	friend class ASDM;
...
public:
	 ...
	 * @return a pointer on a DopplerRow
	 */
	DopplerRow *newRow();
	...
	* @param velDef
	 ...
	 * 
	 * The method creates a new DopplerRow owned by this. Each attribute of the created row 
	 * is a (deep) copy of the corresponding attribute of row. The method does not add 
	 * the created row to this, its simply parents it to this, a call to the add method
	 * has to be done in order to get the row added (very likely after having modified
	 * some of its attributes).
	 * If row is null then the method returns a new DopplerRow with default values for its attributes. 
	 *
	 * @param row the row which is to be copied.
	 */
	 DopplerRow *newRow(DopplerRow *row); 
 ...
 * @returns a pointer to a DopplerRow.	 
 */	
...
std::vector<DopplerRow *> row;
	...
	/**
	  ...
	  * of file(s) containing an external representation of a Doppler table.
	  */
	...
	*/
	...
	/**
	  ...
	  * will be saved in a file "Doppler.bin" or an XML representation (fileAsBin==false) will be saved in a file "Doppler.xml".
