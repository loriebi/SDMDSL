 ...
 * <TR>
 * <TD><I> polarizationId </I></TD>
 * <TD> Tag</TD>
 * <TD> &nbsp; </TD>
 * <TD> &nbsp; Polarization Table identifier </TD>
 * </TR>
...
class PolarizationTable : public Representable {
	friend class ASDM;
...
public:
	...
	// Conversion Methods
	/**
	 * Convert this table into a PolarizationTableIDL CORBA structure.
	 *
	 * @return a pointer to a PolarizationTableIDL
	 */
	 ...
	 *
	 * @param x a reference to the asdmIDL::PolarizationTableIDL to be populated
	 * with the content of this.
	 */
	 void toIDL(asdmIDL::PolarizationTableIDL& x) const;
	 ...
	 * @return a pointer on a PolarizationRow
	 */
	...
	* @param corrProduct
	 ...
	 * 
	 * The method creates a new PolarizationRow owned by this. Each attribute of the created row 
	 * is a (deep) copy of the corresponding attribute of row. The method does not add 
	 * the created row to this, its simply parents it to this, a call to the add method
	 * has to be done in order to get the row added (very likely after having modified
	 * some of its attributes).
	 * If row is null then the method returns a new PolarizationRow with default values for its attributes. 
	 *
	 * @param row the row which is to be copied.
	 */
	 PolarizationRow *newRow(PolarizationRow *row); 
 ...
 * @returns a pointer to a PolarizationRow.	 
 */	
	 ...
	 * @return Alls rows in a vector of pointers of PolarizationRow. The elements of this vector are stored in the order 
	 * in which they have been added to the PolarizationTable.
	 */
	std::vector<PolarizationRow *> get() ;
	
	/**
	 * Get a const reference on the collection of rows pointers internally hold by the table.
	 * @return A const reference of a vector of pointers of PolarizationRow. The elements of this vector are stored in the order 
	 * in which they have been added to the PolarizationTable.
	 *
	 */
	 const std::vector<PolarizationRow *>& get() const ;
...
// In all cases we maintain a private vector of PolarizationRow s.
...
std::vector<PolarizationRow *> row;
	 ...
	 * be conform to the XML schema defined for a Polarization (PolarizationTable.xsd).
	 * @throws ConversionException
	 * 
	 */
	...
	/**
	  ...
	  * of file(s) containing an external representation of a Polarization table.
	  */
	...
	*/
	...
	/**
	  ...
	  * will be saved in a file "Polarization.bin" or an XML representation (fileAsBin==false) will be saved in a file "Polarization.xml".
