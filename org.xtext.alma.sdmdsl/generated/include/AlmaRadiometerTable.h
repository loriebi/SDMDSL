...
#define AlmaRadiometerTable_CLASS
...
public:
	 ...
	 * @return a pointer on a AlmaRadiometerRow
	 */
	 ...
	 * 
	 * The method creates a new AlmaRadiometerRow owned by this. Each attribute of the created row 
	 * is a (deep) copy of the corresponding attribute of row. The method does not add 
	 * the created row to this, its simply parents it to this, a call to the add method
	 * has to be done in order to get the row added (very likely after having modified
	 * some of its attributes).
	 * If row is null then the method returns a new AlmaRadiometerRow with default values for its attributes. 
	 *
	 * @param row the row which is to be copied.
	 */
	 AlmaRadiometerRow *newRow(AlmaRadiometerRow *row); 
 ...
 * @returns a pointer to a AlmaRadiometerRow.	 
 */	
...
std::vector<AlmaRadiometerRow *> row;
	...
	*/
	...
	/**
	  ...
	  * will be saved in a file "AlmaRadiometer.bin" or an XML representation (fileAsBin==false) will be saved in a file "AlmaRadiometer.xml".
...
#endif /* AlmaRadiometerTable_CLASS */
