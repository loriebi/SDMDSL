 ...
 "samplingLevel" , "numAttFreq" , "attFreq" , "attSpectrum" 
	...
	* @param polarizationType
	...
	string GainTrackingTable::toXML()  {
		...
		buf.append("<GainTrackingTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/GainTrackingTable\" xsi:schemaLocation=\"http://Alma/XASDM/GainTrackingTable http://almaobservatory.org/XML/XASDM//GainTrackingTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string GainTrackingTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<GainTrackingTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/GainTrackingTable\" xsi:schemaLocation=\"http://Alma/XASDM/GainTrackingTable http://almaobservatory.org/XML/XASDM//GainTrackingTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
