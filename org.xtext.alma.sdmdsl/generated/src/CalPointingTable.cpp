 ...
 "averagedPolarizations" , "beamPA" , "beamPAError" , "beamPAWasFixed" , "beamWidth" , "beamWidthError" , "beamWidthWasFixed" , "offIntensity" , "offIntensityError" , "offIntensityWasFixed" , "peakIntensity" , "peakIntensityError" , "peakIntensityWasFixed" 
	...
	* @param reducedChiSquared
	...
	string CalPointingTable::toXML()  {
		...
		buf.append("<CalPointingTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalPointingTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalPointingTable http://almaobservatory.org/XML/XASDM//CalPointingTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string CalPointingTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<CalPointingTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalPointingTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalPointingTable http://almaobservatory.org/XML/XASDM//CalPointingTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
