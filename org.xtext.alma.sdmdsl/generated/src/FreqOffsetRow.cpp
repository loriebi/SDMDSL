...
namespace asdm {
	...
	setAntennaId(Parser::getTag("antennaId","FreqOffset",rowDoc));
	setFeedId(Parser::getInteger("feedId","FreqOffset",rowDoc));
	setSpectralWindowId(Parser::getTag("spectralWindowId","FreqOffset",rowDoc));
