...
namespace asdm {
	...
	setDelayModelVariableParametersId(x.delayModelVariableParametersId);
	setTime(x.time);
	setUt1_utc(x.ut1_utc);
	setIat_utc(x.iat_utc);
	setTimeType(x.timeType);
	setGstAtUt0(x.gstAtUt0);
	setEarthRotationRate(x.earthRotationRate);
	polarOffsets .clear();
