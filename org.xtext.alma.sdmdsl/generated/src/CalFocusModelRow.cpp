...
namespace asdm {
	...
	for (unsigned int i = 0; i <x.focusRMS.length(); ++i) {
		focusRMS.push_back(x.focusRMS[i]);
	}
	...
	setCalDataId(Parser::getTag("calDataId","CalFocusModel",rowDoc));
	setCalReductionId(Parser::getTag("calReductionId","CalFocusModel",rowDoc));
