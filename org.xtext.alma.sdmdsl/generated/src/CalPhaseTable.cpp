 ...
 "correctionValidity" 
	...
	* @param statPhaseRMS
	...
	string CalPhaseTable::toXML()  {
		...
		buf.append("<CalPhaseTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalPhaseTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalPhaseTable http://almaobservatory.org/XML/XASDM//CalPhaseTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string CalPhaseTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<CalPhaseTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalPhaseTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalPhaseTable http://almaobservatory.org/XML/XASDM//CalPhaseTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
