 ...
 "releaseDate" , "schedulerMode" , "siteAltitude" , "siteLongitude" , "siteLatitude" , "observingScript" , "observingScriptUID" , "scaleId" 
	...
	* @param sBSummaryId
	...
	string ExecBlockTable::toXML()  {
		...
		buf.append("<ExecBlockTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/ExecBlockTable\" xsi:schemaLocation=\"http://Alma/XASDM/ExecBlockTable http://almaobservatory.org/XML/XASDM//ExecBlockTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string ExecBlockTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<ExecBlockTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/ExecBlockTable\" xsi:schemaLocation=\"http://Alma/XASDM/ExecBlockTable http://almaobservatory.org/XML/XASDM//ExecBlockTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
