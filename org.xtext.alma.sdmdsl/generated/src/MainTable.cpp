...
,
	...
	* @param execBlockId
	...
	string MainTable::toXML()  {
		...
		buf.append("<MainTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/MainTable\" xsi:schemaLocation=\"http://Alma/XASDM/MainTable http://almaobservatory.org/XML/XASDM//MainTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string MainTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<MainTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/MainTable\" xsi:schemaLocation=\"http://Alma/XASDM/MainTable http://almaobservatory.org/XML/XASDM//MainTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
