...
,
 "polarizationsAveraged" , "focusCurveWidth" , "focusCurveWidthError" , "focusCurveWasFixed" , "offIntensity" , "offIntensityError" , "offIntensityWasFixed" , "peakIntensity" , "peakIntensityError" , "peakIntensityWasFixed" , "astigmPlus" , "astigmPlusError" , "astigmMult" , "astigmMultError" , "illumOffset" , "illumOffsetError" , "fitRMS" 
	...
	* @param position
	...
	void CalFocusTable::toIDL(asdmIDL::CalFocusTableIDL& x) const {
		unsigned int nrow = size();
		x.row.length(nrow);
		vector<CalFocusRow*> v = get();
		for (unsigned int i = 0; i < nrow; ++i) {
	...
	string CalFocusTable::toXML()  {
		...
		buf.append("<CalFocusTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalFocusTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalFocusTable http://almaobservatory.org/XML/XASDM//CalFocusTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string CalFocusTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<CalFocusTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalFocusTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalFocusTable http://almaobservatory.org/XML/XASDM//CalFocusTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
