...
namespace asdm { 
	...
	string ASDM::toXML()   {
		...
		out.append("<ASDM xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/ASDM\" xsi:schemaLocation=\"http://Alma/XASDM/ASDM http://almaobservatory.org/XML/XASDM//ASDM.xsd\" schemaVersion=\"\" schemaRevision=\"-1\"> ");
	...
	void ASDM::setFromMIME(const string & ) {
		// To be implemented
		;
	}
	...
	/**
 	...
 	string ASDM::getXMLEntity(EntityId) {
 		throw ConversionException("Not implemented","ASDM");
 	}
 	
 	void ASDM::putXMLEntity(string) {
 		throw ConversionException("Not implemented","ASDM");
 	}
} // End namespace asdm
