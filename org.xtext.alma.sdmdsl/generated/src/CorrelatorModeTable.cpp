...
,
	...
	* @param correlatorName
	...
	string CorrelatorModeTable::toXML()  {
		...
		buf.append("<CorrelatorModeTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CorrelatorModeTable\" xsi:schemaLocation=\"http://Alma/XASDM/CorrelatorModeTable http://almaobservatory.org/XML/XASDM//CorrelatorModeTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string CorrelatorModeTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<CorrelatorModeTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CorrelatorModeTable\" xsi:schemaLocation=\"http://Alma/XASDM/CorrelatorModeTable http://almaobservatory.org/XML/XASDM//CorrelatorModeTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
