...
namespace asdm {
	...
	setCalDataId(Parser::getTag("calDataId","CalSeeing",rowDoc));
	setCalReductionId(Parser::getTag("calReductionId","CalSeeing",rowDoc));
