...
,
	...
	* @param appParms
	...
	string HistoryTable::toXML()  {
		...
		buf.append("<HistoryTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/HistoryTable\" xsi:schemaLocation=\"http://Alma/XASDM/HistoryTable http://almaobservatory.org/XML/XASDM//HistoryTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string HistoryTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<HistoryTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/HistoryTable\" xsi:schemaLocation=\"http://Alma/XASDM/HistoryTable http://almaobservatory.org/XML/XASDM//HistoryTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
