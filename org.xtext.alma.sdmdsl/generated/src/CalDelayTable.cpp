 ...
 "crossDelayOffset" , "crossDelayOffsetError" , "numSideband" , "refFreq" , "refFreqPhase" , "sidebands" 
	...
	* @param appliedDelay
	...
	string CalDelayTable::toXML()  {
		...
		buf.append("<CalDelayTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalDelayTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalDelayTable http://almaobservatory.org/XML/XASDM//CalDelayTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string CalDelayTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<CalDelayTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalDelayTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalDelayTable http://almaobservatory.org/XML/XASDM//CalDelayTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
