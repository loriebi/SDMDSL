 ...
 "subintegrationNumber" 
	...
	* @param execBlockId
	...
	string TotalPowerTable::toXML()  {
		...
		buf.append("<TotalPowerTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/TotalPowerTable\" xsi:schemaLocation=\"http://Alma/XASDM/TotalPowerTable http://almaobservatory.org/XML/XASDM//TotalPowerTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string TotalPowerTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<TotalPowerTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/TotalPowerTable\" xsi:schemaLocation=\"http://Alma/XASDM/TotalPowerTable http://almaobservatory.org/XML/XASDM//TotalPowerTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
