...
,
	...
	* @param water
	...
	string CalWVRTable::toXML()  {
		...
		buf.append("<CalWVRTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalWVRTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalWVRTable http://almaobservatory.org/XML/XASDM//CalWVRTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string CalWVRTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<CalWVRTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalWVRTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalWVRTable http://almaobservatory.org/XML/XASDM//CalWVRTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
