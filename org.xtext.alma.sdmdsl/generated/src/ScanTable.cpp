 ...
 "calibrationFunction" , "calibrationSet" , "calPattern" , "numField" , "fieldName" , "sourceName" 
	...
	* @param calibrationOnLine
	...
	string ScanTable::toXML()  {
		...
		buf.append("<ScanTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/ScanTable\" xsi:schemaLocation=\"http://Alma/XASDM/ScanTable http://almaobservatory.org/XML/XASDM//ScanTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string ScanTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<ScanTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/ScanTable\" xsi:schemaLocation=\"http://Alma/XASDM/ScanTable http://almaobservatory.org/XML/XASDM//ScanTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
