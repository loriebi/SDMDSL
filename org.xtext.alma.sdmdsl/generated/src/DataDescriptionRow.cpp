...
#include <PolOrHoloTable.h>
#include <PolOrHoloRow.h>
...
using asdm::PolOrHoloTable;
using asdm::PolOrHoloRow;
...
namespace asdm {
	...
	setDataDescriptionId(x.dataDescriptionId);
	setPolOrHoloId(x.polOrHoloId);
