 ...
 "numPolarizationType" , "numSpectralWindow" , "numPairedAntenna" , "polarizationType" , "pairedAntennaId" , "spectralWindowId" 
	...
	* @param antennaId
	...
	string FlagTable::toXML()  {
		...
		buf.append("<FlagTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/FlagTable\" xsi:schemaLocation=\"http://Alma/XASDM/FlagTable http://almaobservatory.org/XML/XASDM//FlagTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string FlagTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<FlagTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/FlagTable\" xsi:schemaLocation=\"http://Alma/XASDM/FlagTable http://almaobservatory.org/XML/XASDM//FlagTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
