 ...
 "phasedArrayList" , "numAssocValues" , "assocNature" , "assocConfigDescriptionId" 
	...
	* @param processorId
	...
	string ConfigDescriptionTable::toXML()  {
		...
		buf.append("<ConfigDescriptionTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/ConfigDescriptionTable\" xsi:schemaLocation=\"http://Alma/XASDM/ConfigDescriptionTable http://almaobservatory.org/XML/XASDM//ConfigDescriptionTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string ConfigDescriptionTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<ConfigDescriptionTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/ConfigDescriptionTable\" xsi:schemaLocation=\"http://Alma/XASDM/ConfigDescriptionTable http://almaobservatory.org/XML/XASDM//ConfigDescriptionTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
