...
namespace asdm {
	...
	setAntennaId(Parser::getTag("antennaId","SysPower",rowDoc));
	setFeedId(Parser::getInteger("feedId","SysPower",rowDoc));
	setSpectralWindowId(Parser::getTag("spectralWindowId","SysPower",rowDoc));
