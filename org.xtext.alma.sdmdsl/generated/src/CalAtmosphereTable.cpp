 ...
 "alphaSpectrum" , "forwardEfficiency" , "forwardEfficiencyError" , "sbGain" , "sbGainError" , "sbGainSpectrum" 
	...
	* @param waterError
	...
	string CalAtmosphereTable::toXML()  {
		...
		buf.append("<CalAtmosphereTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalAtmosphereTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalAtmosphereTable http://almaobservatory.org/XML/XASDM//CalAtmosphereTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string CalAtmosphereTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<CalAtmosphereTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalAtmosphereTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalAtmosphereTable http://almaobservatory.org/XML/XASDM//CalAtmosphereTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
