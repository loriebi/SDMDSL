 ...
 "delayRms" , "phaseRms" 
	...
	* @param reducedChiSquared
	...
	string CalPositionTable::toXML()  {
		...
		buf.append("<CalPositionTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalPositionTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalPositionTable http://almaobservatory.org/XML/XASDM//CalPositionTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string CalPositionTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<CalPositionTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalPositionTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalPositionTable http://almaobservatory.org/XML/XASDM//CalPositionTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
