 ...
 "exponent" , "outerScale" , "outerScaleRMS" 
	...
	* @param seeingError
	...
	string CalSeeingTable::toXML()  {
		...
		buf.append("<CalSeeingTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalSeeingTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalSeeingTable http://almaobservatory.org/XML/XASDM//CalSeeingTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string CalSeeingTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<CalSeeingTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalSeeingTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalSeeingTable http://almaobservatory.org/XML/XASDM//CalSeeingTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
