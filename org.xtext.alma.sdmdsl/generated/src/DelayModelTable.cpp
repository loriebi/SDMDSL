 ...
 "timeOrigin" , "atmosphericGroupDelay" , "atmosphericGroupDelayRate" , "geometricDelay" , "geometricDelayRate" , "numLO" , "LOOffset" , "LOOffsetRate" , "dispersiveDelay" , "dispersiveDelayRate" , "atmosphericDryDelay" , "atmosphericWetDelay" , "padDelay" , "antennaDelay" , "numReceptor" , "polarizationType" , "electronicDelay" , "electronicDelayRate" , "receiverDelay" , "IFDelay" , "LODelay" , "crossPolarizationDelay" 
	...
	* @param fieldId
	...
	string DelayModelTable::toXML()  {
		...
		buf.append("<DelayModelTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/DelayModelTable\" xsi:schemaLocation=\"http://Alma/XASDM/DelayModelTable http://almaobservatory.org/XML/XASDM//DelayModelTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string DelayModelTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<DelayModelTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/DelayModelTable\" xsi:schemaLocation=\"http://Alma/XASDM/DelayModelTable http://almaobservatory.org/XML/XASDM//DelayModelTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
