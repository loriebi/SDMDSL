 ...
 "switchedPowerDifference" , "switchedPowerSum" , "requantizerGain" 
	...
	* @param numReceptor
	...
	string SysPowerTable::toXML()  {
		...
		buf.append("<SysPowerTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/SysPowerTable\" xsi:schemaLocation=\"http://Alma/XASDM/SysPowerTable http://almaobservatory.org/XML/XASDM//SysPowerTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string SysPowerTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<SysPowerTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/SysPowerTable\" xsi:schemaLocation=\"http://Alma/XASDM/SysPowerTable http://almaobservatory.org/XML/XASDM//SysPowerTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
