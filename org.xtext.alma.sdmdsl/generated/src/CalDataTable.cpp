 ...
 "assocCalDataId" , "assocCalNature" , "fieldName" , "sourceName" , "sourceCode" , "scanIntent" 
	...
	* @param scanSet
	...
	string CalDataTable::toXML()  {
		...
		buf.append("<CalDataTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalDataTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalDataTable http://almaobservatory.org/XML/XASDM//CalDataTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string CalDataTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<CalDataTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalDataTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalDataTable http://almaobservatory.org/XML/XASDM//CalDataTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
