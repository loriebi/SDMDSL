 ...
 "feedNum" , "illumOffset" , "position" , "skyCoupling" , "numChan" , "skyCouplingSpectrum" 
	...
	* @param receiverId
	...
	const vector<FeedRow *>& FeedTable::get() const {
		 ...
		 *
		* @param alma.hla.datamodel.meta.asdm.ASDMAttribute@66420549 (primitiveType: null, name: antennaId, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: true, refsToMany: false, refsToManySlices: false, refersTo: Antenna, refersTo2: null, doc:  refers to a unique row in AntennaTable.|Antenna Table identifier. ).
		* @param alma.hla.datamodel.meta.asdm.ASDMAttribute@15dc339f (primitiveType: null, name: spectralWindowId, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: true, refsToMany: false, refsToManySlices: false, refersTo: SpectralWindow, refersTo2: null, doc:  refers to a unique row in SpectralWindowTable.|SpectralWindow Table identifier. ).
		* @param alma.hla.datamodel.meta.asdm.ASDMAttribute@6cd56321 (primitiveType: null, name: timeInterval, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: false, refersTo: null, refersTo2: null, doc:  the time interval of validity of the content of the row.|Time Interval of validity of the feed information. ).
		* @param alma.hla.datamodel.meta.asdm.ASDMAttribute@34acbc60 (primitiveType: null, name: numReceptor, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: false, refersTo: null, refersTo2: null, doc:  the number of receptors.|The number of receptors for which the result is given. ).
		* @param alma.hla.datamodel.meta.asdm.ASDMAttribute@42b28ff1 (primitiveType: null, name: beamOffset, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: false, refersTo: null, refersTo2: null, doc:  the offsets of the beam (one pair per receptor).|Offset of the beam. ).
		* @param alma.hla.datamodel.meta.asdm.ASDMAttribute@36061cf3 (primitiveType: null, name: focusReference, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: false, refersTo: null, refersTo2: null, doc:  the references for the focus position (one triple per receptor).|Reference for the focus position. ).
		* @param alma.hla.datamodel.meta.asdm.ASDMAttribute@718dbd79 (primitiveType: null, name: polarizationTypes, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: false, refersTo: null, refersTo2: null, doc:  identifies the polarization types (one value per receptor).|The polarization types of the receptors being used. ).
		* @param alma.hla.datamodel.meta.asdm.ASDMAttribute@20134094 (primitiveType: null, name: polResponse, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: false, refersTo: null, refersTo2: null, doc:  the polarization response (one value per pair of receptors).|The polarization response of the receptors. ).
		* @param alma.hla.datamodel.meta.asdm.ASDMAttribute@76889e60 (primitiveType: null, name: receptorAngle, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: false, refersTo: null, refersTo2: null, doc:  the receptors angles (one value per receptor).|Position angle for X polarization direction. ).
		* @param alma.hla.datamodel.meta.asdm.ASDMAttribute@706fe5c6 (primitiveType: null, name: receiverId, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: true, refersTo: Receiver, refersTo2: null, doc:  refers to one or more collections of rows in ReceiverTable.|Points to the receivers corresponding to this feed. ).
		 */
				...
				if ((mapIter = context.find(k)) != context.end()) {
					...
					for (planeIter = context[k].begin(); planeIter != context[k].end(); planeIter++)  {
						...
						for (rowIter = (*planeIter).begin(); rowIter != (*planeIter).end(); rowIter++) {
							if ((*rowIter)->getTimeInterval().contains(timeInterval)
							    && (*rowIter)->compareRequiredValue([alma.hla.datamodel.meta.asdm.ASDMAttribute@34acbc60 (primitiveType: null, name: numReceptor, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: false, refersTo: null, refersTo2: null, doc:  the number of receptors.|The number of receptors for which the result is given. ), alma.hla.datamodel.meta.asdm.ASDMAttribute@42b28ff1 (primitiveType: null, name: beamOffset, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: false, refersTo: null, refersTo2: null, doc:  the offsets of the beam (one pair per receptor).|Offset of the beam. ), alma.hla.datamodel.meta.asdm.ASDMAttribute@36061cf3 (primitiveType: null, name: focusReference, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: false, refersTo: null, refersTo2: null, doc:  the references for the focus position (one triple per receptor).|Reference for the focus position. ), alma.hla.datamodel.meta.asdm.ASDMAttribute@718dbd79 (primitiveType: null, name: polarizationTypes, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: false, refersTo: null, refersTo2: null, doc:  identifies the polarization types (one value per receptor).|The polarization types of the receptors being used. ), alma.hla.datamodel.meta.asdm.ASDMAttribute@20134094 (primitiveType: null, name: polResponse, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: false, refersTo: null, refersTo2: null, doc:  the polarization response (one value per pair of receptors).|The polarization response of the receptors. ), alma.hla.datamodel.meta.asdm.ASDMAttribute@76889e60 (primitiveType: null, name: receptorAngle, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: false, refersTo: null, refersTo2: null, doc:  the receptors angles (one value per receptor).|Position angle for X polarization direction. ), alma.hla.datamodel.meta.asdm.ASDMAttribute@706fe5c6 (primitiveType: null, name: receiverId, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: true, refersTo: Receiver, refersTo2: null, doc:  refers to one or more collections of rows in ReceiverTable.|Points to the receivers corresponding to this feed. )])) {
								return *rowIter;
							} 
						}
					}
	...
	string FeedTable::toXML()  {
		...
		buf.append("<FeedTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/FeedTable\" xsi:schemaLocation=\"http://Alma/XASDM/FeedTable http://almaobservatory.org/XML/XASDM//FeedTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string FeedTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<FeedTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/FeedTable\" xsi:schemaLocation=\"http://Alma/XASDM/FeedTable http://almaobservatory.org/XML/XASDM//FeedTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
