 ...
 "time" , "code" , "directionCode" , "directionEquinox" , "assocNature" , "ephemerisId" , "sourceId" , "assocFieldId" 
	...
	* @param referenceDir
	...
	string FieldTable::toXML()  {
		...
		buf.append("<FieldTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/FieldTable\" xsi:schemaLocation=\"http://Alma/XASDM/FieldTable http://almaobservatory.org/XML/XASDM//FieldTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string FieldTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<FieldTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/FieldTable\" xsi:schemaLocation=\"http://Alma/XASDM/FieldTable http://almaobservatory.org/XML/XASDM//FieldTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
