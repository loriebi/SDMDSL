...
namespace asdm {
	...
	for (unsigned int i = 0; i <x.chanWidthArray.length(); ++i) {
		chanWidthArray.push_back(x.chanWidthArray[i]);
	}
	}
	...
	for (unsigned int i = 0; i <x.effectiveBwArray.length(); ++i) {
		effectiveBwArray.push_back(x.effectiveBwArray[i]);
	}
	}
	...
	for (unsigned int i = 0; i <x.resolutionArray.length(); ++i) {
		resolutionArray.push_back(x.resolutionArray[i]);
	}
	}
	...
	for (unsigned int i = 0; i <x.assocSpectralWindowId.length(); ++i) {
		assocSpectralWindowId.push_back(x.assocSpectralWindowId[i]);
	}
	}
	...
	setImageSpectralWindowId(x.imageSpectralWindowId);
	}
