...
namespace asdm {
	...
	setAzimuthRMS(x.azimuthRMS);
	setElevationRms(x.elevationRms);
	setSkyRMS(x.skyRMS);
	...
	setCalDataId(Parser::getTag("calDataId","CalPointingModel",rowDoc));
	setCalReductionId(Parser::getTag("calReductionId","CalPointingModel",rowDoc));
