...
namespace asdm {
	...
	setCalDataId(Parser::getTag("calDataId","CalPosition",rowDoc));
	setCalReductionId(Parser::getTag("calReductionId","CalPosition",rowDoc));
