...
,
	...
	* @param offset
	...
	string FreqOffsetTable::toXML()  {
		...
		buf.append("<FreqOffsetTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/FreqOffsetTable\" xsi:schemaLocation=\"http://Alma/XASDM/FreqOffsetTable http://almaobservatory.org/XML/XASDM//FreqOffsetTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string FreqOffsetTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<FreqOffsetTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/FreqOffsetTable\" xsi:schemaLocation=\"http://Alma/XASDM/FreqOffsetTable http://almaobservatory.org/XML/XASDM//FreqOffsetTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
