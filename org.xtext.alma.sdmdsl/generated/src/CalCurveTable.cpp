 ...
 "numBaseline" , "rms" 
	...
	* @param reducedChiSquared
	...
	string CalCurveTable::toXML()  {
		...
		buf.append("<CalCurveTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalCurveTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalCurveTable http://almaobservatory.org/XML/XASDM//CalCurveTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string CalCurveTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<CalCurveTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalCurveTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalCurveTable http://almaobservatory.org/XML/XASDM//CalCurveTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
