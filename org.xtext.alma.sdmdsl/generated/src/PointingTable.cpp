...
namespace asdm {
	...
	* @param pointingModelId
	...
	PointingRow*  PointingTable::checkAndAdd(PointingRow* x, bool ) {
		string keystr = Key( 
		x->getAntennaId() 
							   ); 
	...
	string PointingTable::toXML()  {
		...
		buf.append("<PointingTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/PointingTable\" xsi:schemaLocation=\"http://Alma/XASDM/PointingTable http://almaobservatory.org/XML/XASDM//PointingTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string PointingTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<PointingTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/PointingTable\" xsi:schemaLocation=\"http://Alma/XASDM/PointingTable http://almaobservatory.org/XML/XASDM//PointingTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
