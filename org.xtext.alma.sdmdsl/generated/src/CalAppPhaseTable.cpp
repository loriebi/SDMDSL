 ...
 "typeSupports" , "numSupports" , "phaseSupports" 
	...
	* @param phasedSumAntenna
	...
	string CalAppPhaseTable::toXML()  {
		...
		buf.append("<CalAppPhaseTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalAppPhaseTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalAppPhaseTable http://almaobservatory.org/XML/XASDM//CalAppPhaseTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string CalAppPhaseTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<CalAppPhaseTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalAppPhaseTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalAppPhaseTable http://almaobservatory.org/XML/XASDM//CalAppPhaseTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
