 ...
 "correctionValidity" 
	...
	* @param apertureEfficiencyError
	...
	string CalAmpliTable::toXML()  {
		...
		buf.append("<CalAmpliTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalAmpliTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalAmpliTable http://almaobservatory.org/XML/XASDM//CalAmpliTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string CalAmpliTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<CalAmpliTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalAmpliTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalAmpliTable http://almaobservatory.org/XML/XASDM//CalAmpliTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
