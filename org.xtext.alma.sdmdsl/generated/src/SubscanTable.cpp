 ...
 "subscanMode" , "correlatorCalibration" 
	...
	* @param numSubintegration
	...
	string SubscanTable::toXML()  {
		...
		buf.append("<SubscanTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/SubscanTable\" xsi:schemaLocation=\"http://Alma/XASDM/SubscanTable http://almaobservatory.org/XML/XASDM//SubscanTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string SubscanTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<SubscanTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/SubscanTable\" xsi:schemaLocation=\"http://Alma/XASDM/SubscanTable http://almaobservatory.org/XML/XASDM//SubscanTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
