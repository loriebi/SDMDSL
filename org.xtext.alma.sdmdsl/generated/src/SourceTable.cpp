 ...
 "directionCode" , "directionEquinox" , "calibrationGroup" , "catalog" , "deltaVel" , "position" , "numLines" , "transition" , "restFrequency" , "sysVel" , "rangeVel" , "sourceModel" , "frequencyRefCode" , "numFreq" , "numStokes" , "frequency" , "frequencyInterval" , "stokesParameter" , "flux" , "fluxErr" , "positionAngle" , "positionAngleErr" , "size" , "sizeErr" , "velRefCode" 
	...
	* @param sourceName
	...
	const vector<SourceRow *>& SourceTable::get() const {
		 ...
		 *
		* @param alma.hla.datamodel.meta.asdm.ASDMAttribute@1fde0371 (primitiveType: null, name: timeInterval, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: false, refersTo: null, refersTo2: null, doc:   the time interval of validity of the row's content.|Time Interval of  validity of the source information. ).
		* @param alma.hla.datamodel.meta.asdm.ASDMAttribute@70c0a3d5 (primitiveType: null, name: spectralWindowId, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: true, refsToMany: false, refsToManySlices: false, refersTo: SpectralWindow, refersTo2: null, doc:  refers to a unique row in SpectralWindowTable.|SpectralWindow Table identifier. ).
		* @param alma.hla.datamodel.meta.asdm.ASDMAttribute@5c8e67b9 (primitiveType: null, name: code, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: false, refersTo: null, refersTo2: null, doc:  indicates the nature of the source.|Source code, e.g., Bandpass calibrator. ).
		* @param alma.hla.datamodel.meta.asdm.ASDMAttribute@260a3a5e (primitiveType: null, name: direction, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: false, refersTo: null, refersTo2: null, doc:  the direction of the source.|The source direction, usually EQ J2000.  \\MDirection{directionCode}{directionEquinox}{-}  ).
		* @param alma.hla.datamodel.meta.asdm.ASDMAttribute@49206065 (primitiveType: null, name: properMotion, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: false, refersTo: null, refersTo2: null, doc:  the proper motion of the source.|Source proper motion (change of directiuon with time). ).
		* @param alma.hla.datamodel.meta.asdm.ASDMAttribute@3c0bbc9f (primitiveType: null, name: sourceName, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: false, refersTo: null, refersTo2: null, doc:  the name of the source.|The source name (please respect UAI/IAU standard conventions). ).
		 */
				...
				if ((mapIter = context.find(k)) != context.end()) {
					...
					for (planeIter = context[k].begin(); planeIter != context[k].end(); planeIter++)  {
						...
						for (rowIter = (*planeIter).begin(); rowIter != (*planeIter).end(); rowIter++) {
							if ((*rowIter)->getTimeInterval().contains(timeInterval)
							    && (*rowIter)->compareRequiredValue([alma.hla.datamodel.meta.asdm.ASDMAttribute@5c8e67b9 (primitiveType: null, name: code, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: false, refersTo: null, refersTo2: null, doc:  indicates the nature of the source.|Source code, e.g., Bandpass calibrator. ), alma.hla.datamodel.meta.asdm.ASDMAttribute@260a3a5e (primitiveType: null, name: direction, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: false, refersTo: null, refersTo2: null, doc:  the direction of the source.|The source direction, usually EQ J2000.  \\MDirection{directionCode}{directionEquinox}{-}  ), alma.hla.datamodel.meta.asdm.ASDMAttribute@49206065 (primitiveType: null, name: properMotion, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: false, refersTo: null, refersTo2: null, doc:  the proper motion of the source.|Source proper motion (change of directiuon with time). ), alma.hla.datamodel.meta.asdm.ASDMAttribute@3c0bbc9f (primitiveType: null, name: sourceName, scalar: null, autoIncrementable: false, refsToAslice: false, refsToOne: false, refsToMany: false, refsToManySlices: false, refersTo: null, refersTo2: null, doc:  the name of the source.|The source name (please respect UAI/IAU standard conventions). )])) {
								return *rowIter;
							} 
						}
					}
	...
	string SourceTable::toXML()  {
		...
		buf.append("<SourceTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/SourceTable\" xsi:schemaLocation=\"http://Alma/XASDM/SourceTable http://almaobservatory.org/XML/XASDM//SourceTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string SourceTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<SourceTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/SourceTable\" xsi:schemaLocation=\"http://Alma/XASDM/SourceTable http://almaobservatory.org/XML/XASDM//SourceTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
