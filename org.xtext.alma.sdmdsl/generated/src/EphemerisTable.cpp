 ...
 "numPolyRadVel" , "radVel" 
	...
	* @param origin
	...
	string EphemerisTable::toXML()  {
		...
		buf.append("<EphemerisTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/EphemerisTable\" xsi:schemaLocation=\"http://Alma/XASDM/EphemerisTable http://almaobservatory.org/XML/XASDM//EphemerisTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string EphemerisTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<EphemerisTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/EphemerisTable\" xsi:schemaLocation=\"http://Alma/XASDM/EphemerisTable http://almaobservatory.org/XML/XASDM//EphemerisTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
