 ...
 "numAntenna" , "basebandName" , "numBaseband" , "interval" , "dValue" , "vdValue" , "vvdValues" , "llValue" , "vllValue" , "vvllValue" , "antennaId" 
	...
	* @param details
	...
	string AnnotationTable::toXML()  {
		...
		buf.append("<AnnotationTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/AnnotationTable\" xsi:schemaLocation=\"http://Alma/XASDM/AnnotationTable http://almaobservatory.org/XML/XASDM//AnnotationTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string AnnotationTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<AnnotationTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/AnnotationTable\" xsi:schemaLocation=\"http://Alma/XASDM/AnnotationTable http://almaobservatory.org/XML/XASDM//AnnotationTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
