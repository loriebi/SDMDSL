...
,
 "tcalFlag" , "tcalSpectrum" , "trxFlag" , "trxSpectrum" , "tskyFlag" , "tskySpectrum" , "tsysFlag" , "tsysSpectrum" , "tantFlag" , "tantSpectrum" , "tantTsysFlag" , "tantTsysSpectrum" , "phaseDiffFlag" , "phaseDiffSpectrum" 
	...
	* @param numChan
	...
	void SysCalTable::toIDL(asdmIDL::SysCalTableIDL& x) const {
		unsigned int nrow = size();
		x.row.length(nrow);
		vector<SysCalRow*> v = get();
		for (unsigned int i = 0; i < nrow; ++i) {
	...
	string SysCalTable::toXML()  {
		...
		buf.append("<SysCalTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/SysCalTable\" xsi:schemaLocation=\"http://Alma/XASDM/SysCalTable http://almaobservatory.org/XML/XASDM//SysCalTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string SysCalTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<SysCalTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/SysCalTable\" xsi:schemaLocation=\"http://Alma/XASDM/SysCalTable http://almaobservatory.org/XML/XASDM//SysCalTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
