...
,
	...
	* @param softwareVersion
	...
	string CalReductionTable::toXML()  {
		...
		buf.append("<CalReductionTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalReductionTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalReductionTable http://almaobservatory.org/XML/XASDM//CalReductionTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n");
	...
	string CalReductionTable::MIMEXMLPart(const asdm::ByteOrder* byteOrder) {
		...
		oss << "\n";
		oss << "<CalReductionTable xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:=\"http://Alma/XASDM/CalReductionTable\" xsi:schemaLocation=\"http://Alma/XASDM/CalReductionTable http://almaobservatory.org/XML/XASDM//CalReductionTable.xsd\" schemaVersion=\"\" schemaRevision=\"-1\">\n";
