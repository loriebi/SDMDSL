...
public class LatexTables {
  ...
  public CharSequence output(final AlmaTable table) {
    ...
    _builder.newLine();
    {
      if ((((((!Objects.equal(table.getName(), "FlagCmd")) && (!Objects.equal(table.getName(), "History"))) && (!Objects.equal(table.getName(), "Observation"))) && (!Objects.equal(table.getName(), "Seeing"))) && (!Objects.equal(table.getName(), "TotalPower")))) {
        ...
        _builder.newLine();
        {
          ...
          boolean _notEquals_1 = (!Objects.equal(_doc, ""));
          if (_notEquals_1) {
            _builder.append(" ");
