...
public class CppTableDef {
  ...
  public CharSequence generateCppTableDef(final AlmaTable table) {
    ...
    _builder.newLine();
    {
      if (((table.isTemporal() && table.NoAutoIncrementableAttribute()) && (table.getKeyNoAutoIncrementableAttributes().size() != 0))) {
        _builder.append("/**");
        _builder.newLine();
        _builder.append(" ");
    ...
    _builder.newLine();
    {
      if (((!table.NoAutoIncrementableAttribute()) && (table.getKeyNoAutoIncrementableAttributes().size() != 0))) {
        _builder.append("/**");
        _builder.newLine();
        _builder.append(" ");
    ...
    _builder.newLine();
    {
      ...
      int _size_4 = _requiredNoAutoIncrementableAttributes_2.size();
      ...
      if (_notEquals_4) {
        ...
        _builder.append("* Look up the table for a row whose all attributes ");
        {
          ...
          boolean _not_2 = (!_NoAutoIncrementableAttribute_1);
          if (_not_2) {
    ...
    _builder.newLine();
    {
      ...
      boolean _equals_1 = _name_71.equals("Source");
      if (_equals_1) {
        _builder.append("/*");
        _builder.newLine();
    ...
    _builder.newLine();
    {
      ...
      boolean _not_3 = (!_NoAutoIncrementableAttribute_2);
      if (_not_3) {
        _builder.append("\t ");
    ...
    _builder.newLine();
    {
      ...
      if (_not_4) {
        ...
        _builder.newLine();
        {
          ...
          if (_NoAutoIncrementableAttribute_3) {
            ...
            _builder.newLine();
            {
              ...
              int _size_6 = _keyNoAutoIncNoTimeAttributes_1.size();
        ...
        _builder.newLine();
        {
          ...
          int _size_7 = _keyNoAutoIncNoTimeAttributes_2.size();
