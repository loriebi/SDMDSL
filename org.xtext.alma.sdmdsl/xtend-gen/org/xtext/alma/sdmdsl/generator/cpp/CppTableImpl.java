  ...
  public CharSequence gettersTemporal(final AlmaTable table) {
    ...
    _builder.newLine();
    {
      ...
      if (_not) {
        ...
        {
          if (((!table.NoAutoIncrementableAttribute()) && (table.getRequiredNoAutoIncrementableAttributes().size() != 0))) {
            _builder.append("/**");
            _builder.newLine();
            _builder.append(" ");
            ...
            {
              List<ASDMAttribute> _requiredNoAutoIncrementableAttributes = table.getRequiredNoAutoIncrementableAttributes();
              for(final ASDMAttribute attr : _requiredNoAutoIncrementableAttributes) {
                _builder.append("* @param ");
