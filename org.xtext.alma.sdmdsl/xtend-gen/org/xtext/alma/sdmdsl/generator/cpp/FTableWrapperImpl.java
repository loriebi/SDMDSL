...
public class FTableWrapperImpl {
  ...
  private CharSequence generateModules(final AlmaTable table) {
    StringConcatenation _builder = new StringConcatenation();
    {
      if ((((!Objects.equal(table.getName(), "Beam")) && (!Objects.equal(table.getName(), "Observation"))) && (!Objects.equal(table.getName(), "Ephemeris")))) {
        _builder.append("//! ");
        _builder.newLine();
        _builder.append("//! ===========================================================================");
        _builder.newLine();
        ...
        _builder.newLineIfNotEmpty();
        {
          if (((!Objects.equal(table.getName(), "AlmaRadiometer")) && (!Objects.equal(table.getName(), "Weather")))) {
            {
          ...
          for(final ASDMAttribute attr_3 : _requiredAttributes_2) {
            {
              ...
              if (_isArray) {
                {
                  if ((attr_3.isOneD() || attr_3.isExtrinsic())) {
                    _builder.append("//////");
                    ...
                    if (_isTwoD) {
                      ...
                      if (_isThreeD) {
                        ...
                        if (_isFourD) {
                          ...
                          _builder.append(", allocatable :: ");
                          String _name_12 = attr_3.getName();
  ...
  private CharSequence generateLibrary(final AlmaTable table) {
    StringConcatenation _builder = new StringConcatenation();
    {
      if ((((!Objects.equal(table.getName(), "Beam")) && (!Objects.equal(table.getName(), "Observation"))) && (!Objects.equal(table.getName(), "Ephemeris")))) {
        ...
        {
          String _name_1 = table.getName();
          boolean _equals = Objects.equal(_name_1, "DataDescription");
          if (_equals) {
        ...
        {
          String _name_7 = table.getName();
          boolean _equals_1 = Objects.equal(_name_7, "DataDescription");
          if (_equals_1) {
              ...
              if (_isArray_1) {
                ...
                _builder.newLine();
                {
                  ...
                  if (_isStringType_1) {
                    ...
                    _builder.newLine();
                    {
                      if ((attr_1.isOneD() || attr_1.isExtrinsic())) {
                        _builder.append("////do i=1, ");
        ...
        _builder.newLine();
        {
          ...
          boolean _equals_4 = Objects.equal(_name_28, "DataDescription");
          if (_equals_4) {
              ...
              if (_isArray_2) {
                {
                  if ((attr_3.isOneD() || attr_3.isExtrinsic())) {
                    _builder.append("////integer, parameter :: ");
                    String _name_40 = attr_3.getName();
                    ...
                    if (_isTwoD_2) {
                      _builder.append("////integer, parameter :: ");
                      String _name_41 = attr_3.getName();
                      ...
                      if (_isThreeD_1) {
                        _builder.append("////integer, parameter :: ");
                        String _name_42 = attr_3.getName();
          ...
          for(final ASDMAttribute attr_4 : _requiredAttributes_3) {
            {
              ...
              if (_isArray_3) {
                ...
                _builder.newLine();
                {
                  ...
                  if (_isStringType_3) {
                    _builder.append("////");
                    String _name_50 = attr_4.getName();
                    ...
                    _builder.newLineIfNotEmpty();
                    _builder.append("////do i=1, ");
                    String _name_51 = attr_4.getName();
                    _builder.append(_name_51, "");
                    _builder.append("Rank");
                    _builder.newLineIfNotEmpty();
                    _builder.append("//////");
                    String _name_52 = attr_4.getName();
          ...
          for(final ASDMAttribute attr_5 : _requiredAttributes_4) {
            {
              ...
              if (_isArray_4) {
                {
                  boolean _isOneD = attr_5.isOneD();
                  if (_isOneD) {
                    {
                      boolean _isStringType_4 = attr_5.isStringType();
                      if (_isStringType_4) {
                        _builder.append("////do i=1,");
                        String _name_57 = attr_5.getName();
                        ...
                        _builder.newLineIfNotEmpty();
                        {
                          ...
                          if (_isKey) {
                            _builder.append("//////key%");
                            String _name_58 = attr_5.getName();
                            _builder.append(_name_58, "");
                            _builder.append("(i)(");
                            String _name_59 = attr_5.getName();
              ...
              if (_isKey_2) {
                {
                  ...
                  if (_not) {
                    ...
                    _builder.append(", allocatable :: ");
                    String _name_77 = attr_6.getName();
                ...
                }
                {
                  ...
                  if (_isStringType_5) {
                    _builder.append("////integer :: ");
                    String _name_78 = attr_6.getName();
              ...
              if (_isKey_3) {
                {
                  ...
                  if (_not_1) {
                    ...
                    String _name_79 = attr_7.getName();
                ...
                }
                {
                  ...
                  if (_equals_8) {
                    _builder.append("////");
                    String _name_80 = attr_7.getName();
                    _builder.append(_name_80, "");
                    _builder.append("ListDim = len(keyList%");
                    String _name_81 = attr_7.getName();
                  ...
                  if (_not_2) {
                    {
                      ...
                      if (_isStringType_6) {
                        ...
                        String _name_85 = attr_8.getName();
                        _builder.append(_name_85, "");
                        _builder.append(" = ");
                        String _name_86 = attr_8.getName();
                        _builder.append(_name_86, "");
                        _builder.append("List(i)(1:");
                        String _name_87 = attr_8.getName();
        ...
        _builder.newLineIfNotEmpty();
        {
          if (((!Objects.equal(table.getName(), "TotalPower")) && (!Objects.equal(table.getName(), "Annotation")))) {
            {
          ...
          if (_notEquals_1) {
            {
              ...
              for(final ASDMAttribute attr_11 : _optionalValueAttributes_2) {
                      ...
                      if (_isKey_5) {
                        {
                          ...
                          if (_isStringType_7) {
                            _builder.append("////integer :: ");
                            String _name_113 = attr_11.getName();
                ...
                _builder.newLineIfNotEmpty();
                {
                  ...
                  if (_isArray_10) {
                    {
                      if ((attr_11.isOneD() || attr_11.isExtrinsic())) {
                        _builder.append("////integer, parameter :: ");
                        String _name_114 = attr_11.getName();
                        ...
                        if (_isTwoD_3) {
                          _builder.append("////integer, parameter :: ");
                          String _name_115 = attr_11.getName();
                          ...
                          if (_isThreeD_2) {
                            _builder.append("////integer, parameter :: ");
                            String _name_116 = attr_11.getName();
                            ...
                            if (_isFourD_2) {
                              _builder.append("////integer, parameter :: ");
                              String _name_117 = attr_11.getName();
                ...
                _builder.newLine();
                {
                  ...
                  if (_isArray_11) {
                    ...
                    _builder.newLineIfNotEmpty();
                    _builder.append("//////call sdmMessage(8,3,\'");
                    String _name_124 = table.getName();
                    ...
                    _builder.newLine();
                    {
                      ...
                      if (_isStringType_9) {
                        ...
                        _builder.newLineIfNotEmpty();
                        _builder.append("//////");
                        String _name_129 = attr_11.getName();
                ...
                _builder.append("Table\',\'Error in sdm_add");
                String _name_140 = table.getName();
                ...
                _builder.newLine();
                _builder.append("//subroutine get");
                String _name_142 = table.getName();
                      ...
                      if (_isKey_6) {
                        {
                          ...
                          if (_isStringType_10) {
                            _builder.append("////integer :: ");
                            String _name_147 = attr_11.getName();
                  ...
                  if (_isArray_12) {
                    {
                      if ((attr_11.isOneD() || attr_11.isExtrinsic())) {
                        _builder.append("////integer, parameter :: ");
                        String _name_148 = attr_11.getName();
                        ...
                        if (_isTwoD_4) {
                          _builder.append("////integer, parameter :: ");
                          String _name_149 = attr_11.getName();
                          ...
                          if (_isThreeD_3) {
                            _builder.append("////integer, parameter :: ");
                            String _name_150 = attr_11.getName();
                            ...
                            if (_isFourD_3) {
                              _builder.append("////integer, parameter :: ");
                              String _name_151 = attr_11.getName();
                ...
                _builder.newLine();
                {
                  ...
                  if (_isArray_13) {
                    ...
                    _builder.newLineIfNotEmpty();
                    _builder.append("//////call sdmMessage(8,3,\'");
                    String _name_158 = table.getName();
                    ...
                    _builder.newLine();
                    {
                      ...
                      if (_isStringType_12) {
                        ...
                        _builder.newLineIfNotEmpty();
                        _builder.append("//////");
                        String _name_163 = attr_11.getName();
                ...
                _builder.append("////ireturn = sdm_get");
                String _name_170 = table.getName();
                ...
                _builder.newLine();
                _builder.append("//////call sdmMessageI(8,3,\'");
                String _name_171 = table.getName();
                _builder.append(_name_171, "");
                _builder.append("Table\',\'Error in sdm_get");
                String _name_172 = table.getName();
                ...
                _builder.newLine();
                _builder.append("//end subroutine get");
                String _name_173 = table.getName();
        ...
        _builder.newLine();
        {
          if ((Objects.equal(table.getName(), "TotalPower") || Objects.equal(table.getName(), "Pointing"))) {
            ...
            String _name_174 = table.getName();
              ...
              for(final ASDMAttribute attr_12 : _requiredAttributes_11) {
                ...
                _builder.newLineIfNotEmpty();
                {
                  ...
                  if (_isArray_14) {
                    ...
                    String _name_179 = attr_12.getName();
                    _builder.append(_name_179, "");
                    _builder.append("Dim(:,:,:)");
                    _builder.newLineIfNotEmpty();
                    {
                      if ((attr_12.isOneD() || attr_12.isExtrinsic())) {
                        _builder.append("////integer, parameter :: ");
                        String _name_180 = attr_12.getName();
                        ...
                        if (_isTwoD_5) {
                          _builder.append("////integer, parameter :: ");
                          String _name_181 = attr_12.getName();
                          ...
                          if (_isThreeD_4) {
                            _builder.append("////integer, parameter :: ");
                            String _name_182 = attr_12.getName();
                            ...
                            if (_isFourD_4) {
                              _builder.append("////integer, parameter :: ");
                              String _name_183 = attr_12.getName();
                  ...
                  } else {
                    {
                      ...
                      boolean _equals_13 = Objects.equal(_FType_11, "character*256");
                      if (_equals_13) {
                        _builder.append("////integer, allocatable :: ");
                        String _name_184 = attr_12.getName();
                    ...
                    _builder.append("////integer, parameter :: ");
                    String _name_185 = attr_12.getName();
                ...
                _builder.newLineIfNotEmpty();
                _builder.append("//////call sdmMessage(8,3,\'");
                String _name_187 = table.getName();
                  ...
                  if (_isArray_15) {
                    ...
                    _builder.newLine();
                    {
                      ...
                      if (_isStringType_13) {
                        ...
                        _builder.append("//////do i=1, ");
                        String _name_200 = attr_12.getName();
                    ...
                    boolean _equals_14 = Objects.equal(_FType_12, "character*256");
                    if (_equals_14) {
                      _builder.append("////allocate(");
                      ...
                      _builder.newLine();
                      _builder.append("//////call sdmMessage(8,3,\'");
                      String _name_204 = table.getName();
                ...
                _builder.append("////ireturn = sdm_get");
                String _name_207 = table.getName();
                ...
                _builder.newLine();
                _builder.append("//////call sdmMessageI(8,3,\'");
                String _name_208 = table.getName();
                _builder.append(_name_208, "");
                _builder.append("Table\',\'Error in sdm_get");
                String _name_209 = table.getName();
                ...
                _builder.newLine();
                _builder.append("//end subroutine get");
                String _name_210 = table.getName();
