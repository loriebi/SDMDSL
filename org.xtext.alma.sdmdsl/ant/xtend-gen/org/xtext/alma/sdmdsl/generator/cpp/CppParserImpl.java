...
public class CppParserImpl {
  ...
  public CharSequence DefineType(final ASDMAttribute attr) {
    ...
    _builder.newLine();
    {
      ...
      boolean _equals = Objects.equal(_CppType_2, "int");
      if (_equals) {
        _or = true;
      } else {
        String _CppType_3 = attr.CppType();
        boolean _equals_1 = Objects.equal(_CppType_3, "Tag");
        _or = _equals_1;
      }
      if (_or) {
        _builder.append("\t");
    ...
    _builder.newLine();
    {
      ...
      if (_not) {
        ...
        _builder.newLine();
        {
          ...
          boolean _equals_2 = _CppType_10.equals("int");
          if (_equals_2) {
            _or_1 = true;
          } else {
            String _CppType_11 = attr.CppType();
            boolean _equals_3 = _CppType_11.equals("Tag");
            _or_1 = _equals_3;
          }
          if (_or_1) {
            _builder.append("\t");
            ...
            _builder.newLine();
            {
              ...
              boolean _equals_4 = _CppType_14.equals("Tag");
              if (_equals_4) {
                _builder.append("\t");
                _builder.append("\t\t");
                _builder.newLine();
        ...
        _builder.newLine();
        {
          ...
          if (_isCharType) {
            ...
            if (_isArrayTimeIntervalType_5) {
              ...
              boolean _equals_5 = _CppType_20.equals("Tag");
              if (_equals_5) {
                _builder.append("\t");
                _builder.append("\t");
                _builder.append("try {");
        ...
        _builder.newLine();
        {
          ...
          if (_isArrayTimeIntervalType_6) {
            ...
            boolean _equals_6 = _CppType_27.equals("Tag");
            if (_equals_6) {
              _builder.append("\t");
              _builder.append("\t\t\t");
        ...
        _builder.newLine();
        {
          ...
          if (_isArrayTimeIntervalType_7) {
            ...
            boolean _equals_7 = _CppType_33.equals("Tag");
            if (_equals_7) {
              _builder.append("\t");
              _builder.append("\t\t\t\t");
        ...
        _builder.newLine();
        {
          ...
          if (_isArrayTimeIntervalType_8) {
            ...
            boolean _equals_8 = _CppType_40.equals("Tag");
            if (_equals_8) {
              _builder.append("\t");
              _builder.append("\t\t\t\t\t");
              _builder.append("v_aux.push_back(Tag::parseTag(t.nextToken()));\t\t\t\t\t\t\t");
        ...
        _builder.append(_CppType_44, "\t\t\t");
        _builder.append("> > vv_aux;");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("\t\t");
        _builder.append("vector<");
        String _CppType_45 = attr.CppType();
        _builder.append(_CppType_45, "\t\t\t");
        _builder.append("> v_aux;");
        _builder.newLineIfNotEmpty();
        _builder.append("\t");
        _builder.append("\t\t");
        ...
        _builder.newLine();
        {
          ...
          if (_isArrayTimeIntervalType_9) {
            ...
            _builder.append("\t");
            _builder.append("v_aux.push_back(");
            String _CppType_46 = attr.CppType();
            _builder.append(_CppType_46, "\t\t\t\t\t\t\t\t");
            _builder.append(" (l1, l2));");
            _builder.newLineIfNotEmpty();
            _builder.append("\t");
            _builder.append("\t\t\t\t\t\t");
            ...
            _builder.append("\t");
            _builder.append("v_aux.push_back(");
            String _CppType_47 = attr.CppType();
            _builder.append(_CppType_47, "\t\t\t\t\t\t\t\t");
            _builder.append(" (l1 - l2 / 2, l2));\t");
            _builder.newLineIfNotEmpty();
          } else {
            String _CppType_48 = attr.CppType();
            boolean _equals_9 = _CppType_48.equals("Tag");
            if (_equals_9) {
              _builder.append("\t");
              _builder.append("\t\t\t\t\t\t");
              _builder.append("v_aux.push_back(Tag::parseTag(t.nextToken()));\t\t\t\t\t\t\t");
