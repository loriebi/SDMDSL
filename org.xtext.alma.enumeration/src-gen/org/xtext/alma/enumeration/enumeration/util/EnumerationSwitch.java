 ...
 * @generated
 */
public class EnumerationSwitch<T> extends Switch<T>
{
  /**
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      {
        EnumValueWithoutComma enumValueWithoutComma = (EnumValueWithoutComma)theEObject;
        T result = caseEnumValueWithoutComma(enumValueWithoutComma);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Enum Value Without Comma</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Enum Value Without Comma</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseEnumValueWithoutComma(EnumValueWithoutComma object)
  {
    return null;
  }
